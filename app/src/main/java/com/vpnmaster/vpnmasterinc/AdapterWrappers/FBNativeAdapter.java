...
public class FBNativeAdapter extends RecyclerViewAdapterWrapper {
    ...
    private static final int TYPE_will_dev_33223327_fb_native_ADS = 900;
    ...
    public int getItemViewType(int position) {
        if (isAdPosition(position)) {
            return TYPE_will_dev_33223327_fb_native_ADS;
        }
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        if (getItemViewType(position) == TYPE_will_dev_33223327_fb_native_ADS) {
    ...
    private RecyclerView.ViewHolder onCreateAdViewHolder(ViewGroup parent) {
        ...
        LinearLayout adLayoutContent = (LinearLayout) inflater
                .inflate(R.layout.item_facebook_native_ad_willdev, parent, false);
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        if (viewType == TYPE_will_dev_33223327_fb_native_ADS) {
